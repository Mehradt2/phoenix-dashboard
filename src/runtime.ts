...
declare global{interface Window{__KP_RUNTIME__?:{mode?:'local'|'team';apiBase?:string;release?:string;modelSource?:ModelSource;modelBase?:string}}}
const raw=window.__KP_RUNTIME__||{};
